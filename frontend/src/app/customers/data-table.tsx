...
export function DataTable<TData, TValue>({
  ...
  const handleExport = () => {
    ...
    const dataToExport = rows.map(row => row.original as Customer);

    const headers = ["ID", "Name", "Email", "Total Spent", "Orders", "Status"];
    const csvContent = [
      headers.join(","),
  ...
  const handleDeleteSelected = () => {
    ...
    selectedRows.forEach(row => {
        onDelete((row.original as Customer).id);
    });
    table.resetRowSelection();
    toast({
        title: "Bulk Delete Complete",
        description: `${selectedRows.length} customers deleted.`,
    });
  }
                 ...
                 <AlertDialog>
                    ...
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                            This will permanently delete {table.getFilteredSelectedRowModel().rows.length} selected customer(s). This action cannot be undone.
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
