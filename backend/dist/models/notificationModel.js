...
export async function createNotification({ title, description, user_id, image_url, type = 'info', status = 'draft', scheduled_at, created_by }) {
    try {
...
// Update notification
export async function updateNotification(id, { title, description, user_id, image_url, type, status, scheduled_at, updated_by }) {
    try {
        const fields = [];
        const values = [];
        if (title !== undefined) {
