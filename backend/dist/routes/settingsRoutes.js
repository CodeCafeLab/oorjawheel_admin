...
import { getAdminProfile, putAdminProfile, putAdminPassword, getAdminGeneral, putAdminGeneral, getAdminNotifications, putAdminNotifications, getAllAdminSettings } from '../controllers/adminSettingsController.js';
const router = Router();
// Combined
