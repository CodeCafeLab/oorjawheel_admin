import {
  ...
  getContentItems,
  createContentItem,
  getStaticContent as getStaticContentModel,
  getAllStaticContent as getAllStaticContentModel,
  createStaticContent as createStaticContentModel,
  updateStaticContent as updateStaticContentModel,
  deleteStaticContent as deleteStaticContentModel,
  getContentItemById,
  updateContentItem,
  deleteContentItem,
  getCategories,
...
export async function getPublicContent(req, res, next) {
  try {
    ...
    const [contentTypeRows] = await pool.execute(
      'SELECT id FROM content_types WHERE slug = ? AND is_active = TRUE',
      [content_type_slug]
    );
